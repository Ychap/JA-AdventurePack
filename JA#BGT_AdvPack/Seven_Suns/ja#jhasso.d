...
SAY @25
IF ~OR(2) Global("TalkedToIvanne","GLOBAL",1) Global("IvanneStoryTold","GLOBAL",1) !Dead("RASHAD")~ THEN REPLY @26 DO ~SetGlobal("JA#JHASSO_QUEST","GLOBAL",2)~ GOTO JA#JHASSO_13
IF ~OR(2) Global("TalkedToIvanne","GLOBAL",1) Global("IvanneStoryTold","GLOBAL",1)  Dead("RASHAD")~ THEN REPLY @27 DO ~SetGlobal("JA#JHASSO_QUEST","GLOBAL",3)~ GOTO JA#JHASSO_18
...
SAY @40
IF ~Dead("RASHAD")~ THEN REPLY @41 DO ~SetGlobal("JA#JHASSO_QUEST","GLOBAL",3)~ GOTO JA#JHASSO_18
