...
Global("JA#ELFSONG_QUEST","GLOBAL",2)~ THEN JA#BRULG_10
SAY @5
...
IF ~Global("JA#ELFSONG_QUEST","GLOBAL",3) Global("JA#BRWILYN_WO","LOCALS",1)~ THEN JA#BRULG_22
SAY @27
...
RandomNum(4,1)~ THEN JA#BRULG_6
SAY @47
IF ~~ THEN EXIT
END

IF ~Global("JA#TALKTOBRULG","%EBaldursGate_ElfsongTavern_L1%",2)
RandomNum(4,2)~ THEN JA#BRULG_7
SAY @48
IF ~~ THEN EXIT
END

IF ~Global("JA#TALKTOBRULG","%EBaldursGate_ElfsongTavern_L1%",2)
RandomNum(4,3)~ THEN JA#BRULG_8
SAY @49
IF ~~ THEN EXIT
END

IF ~Global("JA#TALKTOBRULG","%EBaldursGate_ElfsongTavern_L1%",2)
RandomNum(4,4)~ THEN JA#BRULG_9
SAY @50
IF ~~ THEN EXIT
END
