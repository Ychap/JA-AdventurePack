...
CHAIN
IF WEIGHT #-1
~!InParty("XZAR") InParty("JAHEIRA") InMyArea("JAHEIRA") !StateCheck("JAHEIRA",CD_STATE_NOTVALID)~ THEN NIEMAI JA#NIEMAI_12
@5 = @6
== %JAHEIRA_JOINED% @32
== NIEMAI @19
END
...
IF ~Global("Chapter","GLOBAL",%tutu_chapter_7%)~ THEN BEGIN JA#NIEMAI_x19
SAY @48
...
IF ~Dead("XZAR")~ THEN BEGIN JA#NIEMAI_13
SAY @20 = @21
IF ~~ THEN DO ~EraseJournalEntry(@1024) EscapeAreaDestroy(90)~ EXIT
END


IF ~!InParty("XZAR")~ THEN BEGIN JA#NIEMAI_xx0
SAY @47
IF ~~ THEN DO ~EraseJournalEntry(@1024) EscapeAreaDestroy(90)~ EXIT
END
...
CHAIN
IF ~InParty("JAHEIRA") InMyArea("JAHEIRA") !StateCheck("JAHEIRA",CD_STATE_NOTVALID) Global("JA#7706JAHNIEMAIN","LOCALS",0)~ THEN JA#NIEMA JA#NIEMAI_20
@22 DO ~SetGlobal("JA#7706JAHNIEMAIN","LOCALS",1)~
= @23
...
IF ~True()~ THEN BEGIN JA#NIEMAI_15
SAY @24
IF ~Global("SearchIronThrone","GLOBAL",1)~ THEN REPLY @25 GOTO JA#NIEMAI_18
IF ~~ THEN REPLY @26 EXIT
END
