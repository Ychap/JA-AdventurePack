...
SET_WEIGHT TENYA2 11 #%tenya2_state0_weight%
...
IF ~GlobalLT("BOYBODY","GLOBAL",1) Global("HelpTenya","GLOBAL",0)~ THEN BEGIN JA#TENYA_23
  SAY @23
...
IF ~~ THEN BEGIN JA#TENYA_24
  SAY @28
  COPY_TRANS_LATE TENYA2 7
END

IF ~~ THEN BEGIN JA#TENYA_26
  SAY @30
  COPY_TRANS_LATE TENYA2 8
END

IF ~~ THEN BEGIN JA#TENYA_25
  SAY @29
  COPY_TRANS_LATE TENYA2 9
END

IF ~~ THEN BEGIN JA#TENYA_27
  SAY @31
