...
This mod expands upon the content of the BG1 part of a BGT game.
...
30. Marl - Tavern brawl at Feldepost's Inn
...
50. RESTORED: Elfsong Tavern Movie [^2] [^4] [^5]
...
#### v0.7: Release am 21.02.2018 (packed by jastey)
...
#### v6.0 Beta: Release am 06.07.2012

- Komplette Umstrukturierung der Komponenten
- Massives Plus an Inhalt
- (Mod mit v.0.5 nicht mehr vergleichbar)

#### v0.5 Beta: Release am 01.03.2011
...
[^4]: Already restored by BG:EE Classic Movies
[^5]: Already restored by Baldur's Gate: Enhanced Edition Trilogy (EET)
